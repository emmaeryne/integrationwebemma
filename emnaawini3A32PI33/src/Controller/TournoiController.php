...
class TournoiController extends AbstractController
{
    ...
    public function show(int $idTournoi, TournoiRepository $tournoiRepository): Response
    {
        ...
        // Fetch matches associated with this tournoi
    ...
    public function edit(
        ...
        $matches = $tournoi->getMatchs(); // Fetch matches associated with the tournoi
        ...
        return $this->render('tournoi/edit.html.twig', [
            ...
            'equipes' => $equipes,
            'terrains' => $terrains,
            'matches' => $matches, // Pass matches to the template
        ]);
    }
